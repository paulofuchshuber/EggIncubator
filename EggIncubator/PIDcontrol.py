...
try:
    ...
    while(1):
        ...
        P = error*kP
        I += error*kI
        if (I >= potMax-50): #quando está esquentando (inicialmente frio) nao acumular muito I
            I=potMax-50
        ...
        print("Temp: ",round(tempRead,2),"ºC  Erro: ", round(error,2),"ºC  Potencia: ",round(PID+50,2),"%") 
